...
var secuser = client.users.cache.get(args[0].value);
  ...
  .setTitle("Invite ME")
  .setColor('RANDOM')
  .addField("Invite to Discord server", "[Invite the bot here (Recomended!)](https://discord.com/oauth2/authorize?client_id=${clientid}&scope=bot%20applications.commands&permissions=-9)\n[Invite the bot here (Admin Perm)](https://discord.com/oauth2/authorize?client_id=828959241586606110&scope=bot%20applications.commands&permissions=8)")
  .addField("Support", `[Join to  npg official server](https://discord.gg/UA6sSqKXpZ)`)
